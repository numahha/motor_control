...
#define TOTAL_TIME_LENGTH_US     ( 10*1000*1000 ) // micro second
#define ZEROINPUT_TIME_LENGTH_US (  2*1000*1000 ) // micro second

#define SATURATE_VOLTAGE (2.0) // voltage
#define REF_ANGLE (1. * M_PI) // rad
#define P_GAIN (1.*SATURATE_VOLTAGE/M_PI) // V/rad
...
int main()
{
  ...
  for(int i2=0;i2<i;i2++) fprintf(fp, "%f,%f,%f\n", i2*SAMPLING_TIME_US/1000000.,input_data[i2],output_data[i2]);
  fclose(fp);
